...
const SimilarityScoreChart = ({ similarityScores }) => {
  const data = [
    { name: "Price", score: similarityScores.averagePriceScore },
    { name: "Size", score: similarityScores.averageSizeScore },
    { name: "Location", score: similarityScores.averageLocationScore },
    { name: "Amenities", score: similarityScores.averageAmenityScore },
  ];
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <Badge className="bg-green-100 text-green-800">
            {Math.round(cluster.geography.radiusKm)}km radius
          </Badge>
        </div>
      </CardHeader>
      ...
      {isExpanded && (
        <CardContent>
          <div className="mb-4">
            ...
            <SimilarityScoreChart similarityScores={cluster.similarityScores} />
          </div>
