...
import {
  ...
  SelectionSource,
} from "@/components/real-estate/map/PropertyMap";
...
export default function Home() {
  ...
  const handlePropertySelect = (id: string | null, source: SelectionSource) => {
    console.log("Property selected:", id, "from source:", source);
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-gray-500">
                    Properties with similarity scores above this threshold will
                    be grouped together.
                  </div>
                </div>
